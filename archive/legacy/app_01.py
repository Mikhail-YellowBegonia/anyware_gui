...
def main():
    ...
    font_ascii = os.path.join(os.path.dirname(__file__), "DEM-MO typeface", "Mono", "DEM-MOMono-300.otf")
    ...
    while running:
        ...
        if current_time - last_logic_time >= logic_interval:
            ...
            GUI.static(1, 1, "CRT_Cyan", "你好")
            GUI.static(1,3,"CRT_Green","Hello")
            triangle = [(0,0),(10,0),(5,10)]
            GUI.draw_poly(triangle,"White",GUI.gx(1),GUI.gy(2))
            # -------------------------------
